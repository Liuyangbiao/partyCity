...
import com.borui.third.alipay.config.AlipayConfig;
import com.borui.third.alipay.sign.MD5;
import com.borui.third.alipay.sign.RSA;
import com.borui.third.alipay.util.httpClient.HttpProtocolHandler;
import com.borui.third.alipay.util.httpClient.HttpRequest;
import com.borui.third.alipay.util.httpClient.HttpResponse;
import com.borui.third.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
     ...
     * @return 签名结果字符串
     */
	public static String buildRequestMysignByRefund(Map<String, String> sPara) {
    	String prestr = AlipayCore.createLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
        String mysign = "";
//        if(AlipayConfig.sign_type.equals("RSA") ) {
//        	mysign = RSA.sign(prestr, AlipayConfig.ios_private_key, AlipayConfig.input_charset);
//        }
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        //生成签名结果
        String mysign = buildRequestMysignByRefund(sPara);
        //签名结果与签名方式加入请求提交参数组中
