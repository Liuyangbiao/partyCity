...
public class EasemobMessages {
	...
	private static EasemobMessages instance = new EasemobMessages() ;
	
	public static EasemobMessages getInstance(){
		return instance ;
	}
	...
	//	ArrayNode target = (ArrayNode) new ObjectMapper().readTree("").get("");
		ArrayNode target = factory.arrayNode();
		ObjectNode obj = factory.objectNode() ;
		ObjectNode ext = factory.objectNode() ;
		obj.put("msg", "hello word  === 你好吗") ;
		obj.put("type", "txt") ;
		target.add("141639167432329") ;
		EasemobMessages.getInstance().sendMessages("chatgroups", target,obj, "13045821326", ext) ;
	}
}
