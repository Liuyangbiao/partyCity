package com.borui.third.alioss.api;

import java.io.OutputStream;

import com.borui.third.alioss.common.AliOSSUtil;
...
public class AliOSS {
	...
	/**
	 * 上传图片输出流到阿里云
	 * 1、默认上传到mumu-storage上的images目录下
	 * 2、fileName为上传到阿里云上的命名，要写上路径，如20150320/1.jpg
	 * 3、out 为上传文件的输出流
	 * @function: uploadImg 
	 */
	public static void uploadImg(String fileName, OutputStream out)
			throws Exception {
	 ...
	 * @function: uploadImg 
	 */
	public static void uploadImg(String key, String fileName)
			throws Exception {
	...
	/**
	 * 上传文件输出流到阿里云
	 * 1、默认上传到mumu-storage上的files目录下
	 * 2、key为上传到阿里云上的命名，要写上路径，如20150320/1.xml
	 * 3、out为原始文件输出流 
	 * @function: uploadFile 
	 */
	public static void uploadFile(String fileName, OutputStream out)
			throws Exception {
		AliOSSUtil.uploadFile(AliOSSConfig.BASE_BUCKET, AliOSSConfig.BASE_FILE_FOLDER+fileName, out, 2);
	}
	 ...
	 * 1、默认上传到mumu-storage上的files目录下
	 * 2、key为上传到阿里云上的命名，要写上路径，如20150320/1.xml
	 * 3、fileName为原始文件路径，如d:/20150320/1.xml 
	 * @function: uploadFile 
	 */
	public static void uploadFile(String key, String fileName)
			throws Exception {
		AliOSSUtil.uploadFile(AliOSSConfig.BASE_BUCKET, AliOSSConfig.BASE_FILE_FOLDER+key, fileName, 2);
	}
